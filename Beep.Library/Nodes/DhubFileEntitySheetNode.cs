...
namespace Beep.Library.Nodes
{
    ...
    public class DhubFileEntitySheetNode : IBranch
    {

        public DhubFileEntitySheetNode(LibraryFilesViewModel viewModel, ITree pTreeEditor, IDMEEditor pDMEEditor, IBranch pParentNode, string pBranchText, int pID, EnumPointType pBranchType, string pimagename, string connectionname)
        {
        ...
        public string BranchDescription { get; set; } = "File entity sheet node for File Library";
        ...
        [Command(Caption = "View Structure", Hidden = false, DoubleClick = true, iconimage = "structure.png")]
        ...
        [Command(Caption = "Show", Hidden = false, DoubleClick = true, iconimage = "edit.png")]
